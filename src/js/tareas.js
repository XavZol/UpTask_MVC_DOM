(function () {
    ...
    function mostrarFormulario(editar = false, tarea = {}) {
            ...
            <form class="formulario nueva-tarea">
                ...
                <div class="campo">
                    ...
                    <input
                        type="text"
                        name="tarea"
                        placeholder="${tarea.nombre ? 'Edita la Tarea' : 'Añadir nombre al proyecto actual'}"
                        id="tarea"
                ...
                <div class="opciones">
                    ...
                    />
                    <button type="button" class="cerrar-modal" value="Cancelar">Cancelar</button>
                </div>
            </form>
        ...
        modal.addEventListener('click', function (e) {
            ...
            //Nueva funcion contains verifica si contiene una clase especifica
    ...
    function mostrarAlerta(mensaje, tipo, referencia) {
        ...
        // Eliminar la alerta despúes de 5 segundos
        setTimeout(() => {
            alerta.remove();
        }, 5000);
    ...
    function limpiarTareas() {
        const listadoTareas = document.querySelector('#listado-tareas');
        // El while es más rápido que innerHTML = ''
